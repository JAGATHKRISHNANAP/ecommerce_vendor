...
// //                 {images.map(image => (
// //                   <div key={image.id} style={{ position: 'relative', width: '100px', border: image.isPrimary ? '2px solid blue' : '1px solid #ccc' }}>
// //                     <img
// //                       src={image.preview}
// //                       alt="Preview"
...
// //                         left: '0', 
// //                         fontSize: '10px', 
// //                         background: image.isPrimary ? 'blue' : 'gray',
// //                         color: 'white',
// //                         border: 'none',
// //                         padding: '2px 4px'
// //                       }}
...
// //             disabled={loading}
// //             style={{ marginRight: '10px', backgroundColor: '#007bff', color: 'white', border: 'none', padding: '8px 15px' }}
// //           >
...
// //             disabled={loading}
// //             style={{ backgroundColor: '#6c757d', color: 'white', border: 'none', padding: '8px 15px' }}
// //           >
// //             Cancel
// //           </button>
// //         </div>
...
// //                 <td style={{ border: '1px solid #ccc', padding: '8px' }}>{product.sku || '-'}</td>
// //                 <td style={{ border: '1px solid #ccc', padding: '8px' }}>₹{(product.base_price / 100).toFixed(2)}</td>
// //                 <td style={{ border: '1px solid #ccc', padding: '8px' }}>{product.stock_quantity}</td>
...
// // Complete Products.jsx with proper image upload handling
// import React, { useState, useEffect } from 'react';
// import { api } from '../../services/api/productAPI';
...
//       submitData.append('base_price', (parseInt(formData.base_price) * 100).toString()); // Convert to cents
